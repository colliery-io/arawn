---
id: replace-hand-rolled-cli-argument
level: task
...
# Replace hand-rolled CLI argument parsing with clap
...
- [ ] Invalid arguments produce helpful error messages (not silent defaults)
- [ ] `clap` added to `crates/arawn/Cargo.toml`

## Implementation Notes
- File: `crates/arawn/src/main.rs`
